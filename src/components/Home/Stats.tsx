  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      statBlocks.forEach((block) => {
        const numberElement = (block as HTMLElement).querySelector(".stat-number");
          ...
          gsap.fromTo(
            ...
            { textContent: "0" },
            {
              ...
              onUpdate: function (this: any) {
                const tweenedValue = Math.ceil(Number(this.targets()[0].textContent));
      ...
      <div className="bg-secondary rounded-lg px-6 py-10 text-white sm:px-8 sm:py-12">
        <div className="mx-auto grid max-w-6xl grid-cols-2 items-center justify-between gap-x-6 gap-y-10 text-center sm:grid-cols-2 md:grid-cols-4">
          <div className="stat-block">
            ...
            <div className="text-sm sm:text-base">Happy Kids</div>
          </div>
          <div className="stat-block">
            <div className="stat-number font-fredoka mb-2 text-4xl font-semibold sm:text-5xl md:text-6xl">
              35+
            </div>
            <div className="text-sm sm:text-base">Expert Team</div>
          </div>
          <div className="stat-block">
            <div className="stat-number font-fredoka mb-2 text-4xl font-semibold sm:text-5xl md:text-6xl">
              15+
          ...
          <div className="stat-block">
            ...
            <div className="text-sm sm:text-base">Custom Parties</div>
          </div>
        </div>
      </div>
    </div>

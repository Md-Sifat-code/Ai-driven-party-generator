...
const PremiumBanner: React.FC = () => {
  ...
  return (
    <div ref={sectionRef} className="mx-auto mt-16 w-full max-w-[1440px]">
      ...
      >
        {/* Top wave */}
        <div className="banner-wave-top absolute top-0 left-1/2 z-10 w-full max-w-[1440px] -translate-x-1/2 overflow-hidden leading-none">
          <EdgeWave />
        </div>
        ...
        {/* Bottom wave */}
        <div className="banner-wave-bottom absolute bottom-0 left-1/2 w-full max-w-[1440px] -translate-x-1/2 rotate-180 overflow-hidden leading-none">
          <EdgeWave />
        </div>
      </section>
    </div>

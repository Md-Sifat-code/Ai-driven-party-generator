      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-6 rounded-lg bg-white p-6 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <select className="rounded-lg border border-gray-200 px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:outline-none">
        ...
        {activeTab === "list" ? (
                  ...
                  <div className="p-5">
                    ...
                    <div className="mb-4 space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-[#5A5C5F]">
                        ...
                        <span className="text-sm">{provider.price}</span>
                      </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                      <button className="flex-1 cursor-pointer rounded-lg border border-gray-300 px-4 py-2 text-gray-700 hover:bg-gray-50">
                        View Profile
                      </button>
                      <button className="bg-secondary hover:bg-secondary-dark flex-1 cursor-pointer rounded-lg px-4 py-2 text-white">
                        Request Quote
                      </button>
                    </div>
                  </div>
          ...
          <div className="rounded-lg bg-white p-10 text-center text-xl text-gray-700 shadow-sm">

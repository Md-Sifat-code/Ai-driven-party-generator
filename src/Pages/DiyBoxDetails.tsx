        ...
        return (
          <div className="py-10">
            <div className="rounded-2xl bg-[#DFE1E6] p-6">
              ...
              <div className="relative h-[16rem] md:h-[32rem] w-auto">
                {/* Background Image */}
                <img
                  src={videoImg}
                  alt=""
        ...
        <div className="overflow-hidden rounded-2xl p-4">
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="p-6 lg:w-1/2 lg:p-8">
              ...
              {/* Product Title */}
              <h3 className="font-fredoka mb-2 text-3xl font-semibold text-[#191919]">
                {activity?.title}
              </h3>
              ...
              <div className="mt-8 mb-12">
                <div className="flex items-center gap-2">
                  <span className="text-5xl font-bold text-[#223B7D]">
                    ${activity?.price}
                  </span>
